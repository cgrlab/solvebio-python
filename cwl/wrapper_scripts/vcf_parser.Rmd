...
CommandLineBinding(position = 2, prefix = ">", valueFrom = list('{var name = $job.inputs.vcf.name.split(".vcf")[0]; return name + ".vcf.json"}')),
  
CommandLineBinding(position = 3, valueFrom = list('"&& ls -lhrt"'))
